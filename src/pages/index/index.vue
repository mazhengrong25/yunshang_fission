    ...
    <view class="index">
        ...
        <view class="index_main">
            ...
            <view class="header_type">
                <view v-for="(item,index) in headerType" :key="index" :class="['type_title',{active: currentHeader === index}]" @click="switchTicketType(index)"><view>{{ item }}</view></view>
            </view>
            ...
            <view class="header" v-show="currentHeader === 0">
                ...
                <view class="modal_tabs">
                    <view class="swiper-tab">
                        <view v-for="(item, index) in tabsList" :key="index" :class="['swiper-tab-item', { active: currentTab === index }]" @click="clickTab(index)">{{ item }}</view>
                    </view>

                    <swiper class="tabs_main" :current="currentTab" duration="300" :style="{ height: swiperHeight + 'px' }" @change="swiperTab">
                        <swiper-item v-for="(item, index) in tabsList" :key="index" @touchmove.stop="stopTouchMove">
                            <view class="tabs_center">
                                <ticket-input :ticketType="item" :addressForm="airMessage" @checkTicked="checkTicked" @closeFromBtn="closeFromBtn"></ticket-input>
                            </view>
                        </swiper-item>
                    </swiper>
                </view>
                ...
                <view class="multi_pass_message" v-if="currentTab === 3" @click="openMultiPassProblem">至少选择一个国际城市</view>

                <view class="submit_btn" @click="submitTicket">{{ currentTrue ? "往返" : "" }}飞机票查询</view>
            ...
            <view class="ticket_train" v-show="currentHeader === 1">
                ...
                <view class="train_ticket_input">
                    <ticket-input :ticketClassify="currentHeader" :ticketType="item" :addressForm="airMessage" @checkTicked="checkTicked" @closeFromBtn="closeFromBtn"></ticket-input>
                </view>

                <view :class="['ticket_checkbox',{active:checkboxStatus}]" @click="activeCheckbox()">
        ...
        <uni-popup ref="childPopup" type="bottom" class="child_dialog" @change="childPopupStatus">
            <view class="child_dialog_mian">
                ...
                ]" @click="editTicketNumber('remove', 'adult')"></view>
                ...
                ]" @click="editTicketNumber('remove', 'child')"></view>
                ...
                ]" @click="editTicketNumber('remove', 'baby')"></view>
        ...
        <!-- 儿婴票说明弹窗 -->
        <uni-popup ref="ticketExplanation" class="ticket_explanation" type="bottom" @change="childPopupStatus">
            <view class="title">
    ...
    .header {
        ...
        .child_box {
            ...
            .passenger_message {
                ...
                align-items: center;
                .child_message {
                    background: url("@/static/waring_icon.png") no-repeat center
                        center;
        ...
        .multi_pass_message {
            ...
            &::after {
                content: "";
                background: url(@/static/problem_icon.png) no-repeat center
                    center;
                display: block;
                background-size: contain;
                width: 30upx;
