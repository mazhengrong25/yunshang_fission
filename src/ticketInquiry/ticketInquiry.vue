 ...
 * @LastEditTime: 2022-04-27 11:33:43
 * @LastEditors: mzr
-->
...
<template>
    <view class="ticket_inquiry">
        ...
        <scroll-view :enable-back-to-top="true" :scroll-y="true" :scroll-top="scrollTop" @scroll="scroll" class="ticket_content" lower-threshold="100">
            <view class="ticket_list" v-for="(item, index) in ticketList" :key="index" @click="jumpFlightInfo(item)">
                ...
                $dateTool(item.segments[0].depTime, "HH:mm")
                            ...
                            <view class="ticket_address">{{ item.segments[0].depAirport_CN.air_port_name
                }}{{
                  ...
                  Math.floor(item.segments[0].duration % 60)
                        ...
                        <view class="ticket_end ticket_time">
                            ...
                            <view class="ticket_address">{{ item.segments[item.segments.length - 1].arrAirport_CN.air_port_name
                }}{{
                  item.segments[item.segments.length - 1].arrTerminal !== "--"
                    ...
                    <view class="ticket_details">
                        <image class="ticket_details_icon" :src="
              ...
              " mode="contain" />
                        ...
                        <text v-if="item.sourceCode === 'G5'">&nbsp;|</text>
                        <view class="ticket_details_source" v-if="item.sourceCode === 'G5'">通程</view>
                    </view>
                </view>

                <view class="ticket_right">
                    <view class="ticket_price">
                        <text class="currency" v-if="
              ...
              ">{{ item.min_price }}</view>
                    ...
                    <view class="ticket_cabin" v-if="item.first_cabin.discount">{{ item.first_cabin.cabinInfo.cabinDesc
        ...
        <flight-filter-dialog ref="filterDialog" @ticketFilterData="ticketFilter" :airlines="airlineList"></flight-filter-dialog>
    </view>
</template>
