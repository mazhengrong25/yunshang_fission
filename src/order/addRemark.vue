...
<template>
    <view class="remark">
        <yun-header :statusHeight="iStatusBarHeight"  :headerColor="true" centerTitle="添加备注"></yun-header>
        <view class="content">
            <textarea 
                :maxlength="100"
                placeholder-style="color:#DFDFDF" style="padding:20rpx"
                v-model="content" placeholder="请输入备注信息"/>
