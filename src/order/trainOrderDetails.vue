 ...
 * @LastEditTime: 2021-10-12 16:55:12
 * @LastEditors: mzr
-->
<template>
    <view class="train_details">
        ...
        <view class="details_header">
            ...
            <view class="remaining_time">
                <image class="time_icon" v-if="detailData.status === 1 || detailData.status === 2" src="@/static/order_remaining_time.png" mode="aspectFit" />
            ...
            <view class="order_option">
                ...
                <view class="option_btn important_btn" v-if="detailData.status === 5" @click="againReserve()">再次预定</view>
                <view class="option_btn important_btn" @click="againReserve()" v-if="detailData.status === 6 || detailData.status === 7">重选车次</view>
            </view>
        </view>
            ...
            <scroll-view :enable-back-to-top="true" :scroll-y="true" class="content">
                ...
                { main_list_title_label: detailData.ticket_number },
                    ...
                    <view class="passenger_list">
                        <view :class="['list_item_title', { active: passInfoChecket === index }]" v-for="(item, index) in detailData.passengers" :key="index">
        ...
        <!-- 取消订单弹窗 -->
        <yun-config ref="yunConfig" @submitConfig="getCancelSubmit" title="温馨提示" content="您是否要取消此订单" submitIndex="right"></yun-config>
            ...
            <view class="price_info">
                ...
                <view class="price_info_box">
                    ...
                    <scroll-view :scroll-y="true" class="price_info_main">
                        <view :class="['price_info_list', { active: priceInfoChecket === index }]" v-for="(item, index) in detailData.passengers" :key="index">
                            <view class="list_title" @click="openPriceInfo(index)">
                                <view class="title_name">{{ item.PassengerName }}
    ...
    .details_header {
        ...
        .header_top {
            ...
            .order_price {
                ...
                &::after {
                    content: "";
                    background: url(@/static/arrow_white.png) no-repeat center
                        center;
                    ...
                    .passenger_list {
                        ...
                        .list_item_title {
                            ...
                            .list_info {
                                ...
                                .is_insurance {
                                    background: url(@/static/insurance_icon.png)
