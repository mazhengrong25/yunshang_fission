 ...
 * @LastEditTime: 2021-11-24 11:12:54
 * @LastEditors: mzr
 * @Description: 改签
...
<template>
    <view class="change">
        ...
        <scroll-view :enable-back-to-top="true" :scroll-y="true" class="content">
            <!-- 改签信息 -->
            <refundTop :dataList="list" @voluntary="volRadio" @cause="causeSel" @change="typeRadio" :valueType="valueType" :volunType="radioValue" :changeReason="cause" topStatus="change"></refundTop>
            ...
            <view class="main_list passenger">
                ...
                <view class="passenger_list">
                    <view :class="['list_item', { active: item.active }]" v-for="(item, index) in changeDetail.ticket_passenger" :key="index" @click="checkedPassenger(item, index)">
            ...
            <!-- 原航班 -->
            <flight-header v-if="flightData.data.length > 0" :flightData="flightData" :roundTripFlightData="roundTripFlightData" :roundTripType="roundTripType" :interType="false" flightTitle="change"></flight-header>
            ...
            <!-- 新航班 -->
            <flight-header v-if="flightNewData.data.length > 0" :flightData="flightNewData" :interType="true" flightTitle="new" @changeNewTicket="queryFlightData"></flight-header>
...
export default {
    ...
    methods: {
        ...
        checkedPassenger(val, index) {
            ...
            this.checkedAllStatus =
                this.checkedPassengerlist.length === this.changeDetail.ticket_passenger.length;
        ...
        getNewAddress(key, price) {
            ...
            ticket.getTicketInfo(key, newData).then((res) => {
                console.log(res);
    ...
    onLoad(data) {
        ...
        this.flightData = {
            flightType:
                this.changeDetail.ticket_segments.length === 2
