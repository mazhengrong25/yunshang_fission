 ...
 * @LastEditTime: 2022-05-10 10:23:13
 * @LastEditors: mzr
-->
<template>
    <view class="train_reservation">
        ...
        <view class="reservation_background">
            <scroll-view :enable-back-to-top="true" :scroll-y="true" class="reservation_content" lower-threshold="100">
                ...
                <view class="passenger_box common_style">
                    <view class="passenger_top">
                        <view class="passenger_title">
                            ...
                            <text v-else>已选{{ passengerNumber.adt ? passengerNumber.adt + "成人" : ""
                }}{{
                  passengerNumber.chd ? "，" + passengerNumber.chd + "儿童" : ""
                    ...
                    <uni-swipe-action class="passenger_main" v-if="passengerList.length > 0">
                        ...
                        <view class="add_child_btn" @click="openAdultDialog(passengerList)" v-if="!changeSubmitStatus">
                ...
                <!-- 选座服务 -->
                <view class="selection_service common_style" v-if="!isShowSeat() && !changeSubmitStatus && passengerList.length > 0">
                    <view class="selection_top">
                        <view class="top_title">选座服务</view>
                        <view class="top_action" v-if="
                trainData.train &&
              ...
              ">
                  ...
                  { active: this.getSeatNumber() === passengerList.length },
                    ...
                    <!-- 座位 -->
                    <view :class="this.getSeatNumber() === passengerList.length ? 'notSeat' : ''" v-if="
              trainData.train &&
                (trainData.train.type === 'G' ||
                  trainData.train.type === 'D' ||
                  trainData.train.type === 'C')
        ...
        <view class="bottom_bar">
            ...
            <view class="right_half">
                ...
                <button v-if="changeSubmitStatus" class="right_btn is_background" @click="submitOrder">
                    提交订单
                </button>
            </view>
        </view>
        ...
        <uni-popup ref="childDescription" type="bottom">
            <view class="child_modal_box">
                ...
                <view class="modal_box_content">
                    ...
                    <text>备注：请根据儿童实际身高购票，{{headerName}}不承担因儿童身高与所购车票不符而无法进站的责任。</text>
                </view>
            </view>
        </uni-popup>
            ...
            <view class="adult_modal_box">
                ...
                <view class="modal_box_content">
                    <view :class="['cert_box', { active: item.name === checkedAdtPassenger.name }]" v-for="(item, index) in passengerList" :key="index" @click="checkedCard(item)" v-if="item.type !== '儿童'">
                        ...
                        <view class="box_input">{{ accountId ? "证件" : item.cert_type }}尾号{{
                accountId
                  ? item.card_no
        ...
        <!-- 核验弹窗 -->
        <passengerVerify ref="verifyPopup" :passengerData="verifyPassengerData" @jumpVerify="jumpVerify"></passengerVerify>
    </view>
</template>
        ...
        .selection_service {
            ...
            .notSeat {
                .selection_siting {
                    .seat_item {
                        .seat_single {
                            background: url("@/static/train_not_seat.png")
                                no-repeat center center;
                            background-size: contain;
                            .seat_number {
                                color: #95a1ae;
