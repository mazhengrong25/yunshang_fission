<template>
    <view class="top_bar" :style="style">
        <view class="inner flexbox flex_alignc" :class="[fixed ? 'fixed' : '']" v-bind:style="{'height': customBarH + 'px', 'padding-top': statusBarH + 'px', 'color': titleTintColor, background:bgColor}">
            <!-- 返回 -->
...
<script>
    export default {
        ...
        props: {
            ...
            bgColor: {type: String, default: '#0070E2'},
